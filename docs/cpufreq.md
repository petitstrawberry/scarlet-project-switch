...
The driver owns PLLX and the CPU MAX77621 at I2C5 address `0x1b`.
...
When checking a transition, read the actual frequency and confirm that input,
application work and clock/sleep wakeups continue under low and high load.
The reported frequency comes from hardware readback.

DFLL initialization, higher frequencies, thermal policy and EMC scaling are
outside this driver. Unsupported inherited DFLL/divider states, fuses or
